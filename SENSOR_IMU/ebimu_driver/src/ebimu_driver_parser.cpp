...
// SER WRITE -------------------------------------------------------------
void pharos2ros_callback(const std_msgs::String::ConstPtr& msg){
    ser.write(msg->data);
}
...
int main (int argc, char** argv){
    ...
    pnh.param<std::string>("frame_id", imu_pharos.header.frame_id, "ebimu");

    ros::Subscriber write_sub = nh.subscribe("/pharos/imu/raw", 1, pharos2ros_callback);
