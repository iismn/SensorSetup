...
namespace velodyne_rawdata
{
  ...
  public:
    ...
    void unpack(const velodyne_msgs::VelodynePacket &pkt, VPointCloud &pc ,velodyne_msgs::custompoint *my_msg);///내가 만듬
  ...
  private:
    ...
    void unpack_vlp16(const velodyne_msgs::VelodynePacket &pkt, VPointCloud &pc , velodyne_msgs::custompoint *my_msg);
