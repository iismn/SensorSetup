...
void ROSPixelCloudFusionApp::ImageCallback(const sensor_msgs::CompressedImage::ConstPtr &in_image_msg)
{
  if (!camera_info_ok_)
  {
  ...
  cv::Mat in_image = cv::imdecode(cv::Mat(in_image_msg->data),1);
